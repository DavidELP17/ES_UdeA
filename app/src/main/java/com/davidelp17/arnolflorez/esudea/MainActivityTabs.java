...
public class MainActivityTabs extends AppCompatActivity {
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        if (fragmentTransaction) {
                            getSupportFragmentManager().beginTransaction()
                                    .replace(R.id.content_frame1, fragment, fragmentName1)
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new CheeseListFragment(), "Facultades");
        adapter.addFragment(new CheeseListFragment(), "Extension");
        adapter.addFragment(new CheeseListFragment(), "Bienestar");
