...
public class HomeActivityRaw extends AppCompatActivity {
    public static final String TAGHomeActivity = "HomeActivityRaw";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.home_activity_home_raw);
