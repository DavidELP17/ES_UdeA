package com.davidelp17.arnolflorez.esudea.Galeria.UI;
...
import com.davidelp17.arnolflorez.esudea.Galeria.Provider.Photos;
import com.davidelp17.arnolflorez.esudea.Galeria.Utils.ImageCache;
import com.davidelp17.arnolflorez.esudea.Galeria.Utils.ImageFetcher;
...
public class PhotoGalleryFragment extends Fragment implements AdapterView.OnItemClickListener {
    public static final String TAGPhotoGallery = "PhotoGalleryFragment";
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        final View v = inflater.inflate(R.layout.fragment_photogallery, container, false);
                ...
                if(mAdapter.getNumColumns() == 0){
                    ...
                    if(numColumns > 0){
                        ...
                        if(BuildConfig.DEBUG){
                            Log.d(TAGPhotoGallery,"onCreateView - numColumns set to " + numColumns);
                        }
