...
public class ContracEstudiantes {
    ...
    public static final String INSERT_ESTUDIANTES_SCRIPT =
            "insert into "+ESTUDIANTES_TABLE_NAME+ " values ("+
                    "1," + "\"Juan Lopez\","+"\"1214567835\"," + "\"juan.lopez\","+ "\"juan.lopez@udea.edu.co\","+ "\"pw1\"," + "\"Facultad de Ingeniria\"," + "\"Ingenieria Industrial\"),(" +
                    "2," + "\"Luis Lopez\","+"\"1214798635\"," + "\"luis.lopez\","+ "\"luis.lopez@udea.edu.co\","+ "\"pw2\"," + "\"Facultad de Ingeniria\"," + "\"Ingenieria Mecanica\"),(" +
