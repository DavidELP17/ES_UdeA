...
public class EventsAdapter extends RecyclerView.Adapter<EventsAdapter.ViewHolder> {
        ...
        public ViewHolder(View v) {
            ...
            v.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent EventsActivity = new Intent(v.getContext(), com.davidelp17.arnolflorez.esudea.Events.EventsDetailActivity.class);
                    EventsActivity.putExtra(UniversityDetailActivity.EXTRA_NAME, GC.getText().toString());
     ...
     */
    public EventsAdapter(String[] dataGC, String[] dataGH, String[] dataGM, String[] dataGS) {
        mDataGC = dataGC;
        mDataGH = dataGH;
        mDataGM = dataGM;
        mDataGS = dataGS;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        RelativeLayout = (ImageView) v.findViewById(R.id.eventhome);
