...
public class MapViewPager extends FrameLayout implements OnMapReadyCallback
{
    ...
    public void start(@NonNull FragmentActivity activity, @NonNull AbsAdapter mapAdapter, @Nullable Callback callback)
    {
    ...
    public void start(@NonNull FragmentActivity activity, @NonNull AbsAdapter mapAdapter, int initialPosition, @Nullable Callback callback)
    {
    ...
    private void moveToMulti(int page, boolean animate)
    {
        ...
        hideInfoWindowMulti();
        if (allMarkers.get(page) != null && allMarkers.get(page).size() == 1 && allMarkers.get(page).get(0) != null)
        {
            // this page has only one marker
    ...
    public static class Builder
    {
        ...
        public Builder mapPadding(int mapPaddingLeft, int mapPaddingTop, int mapPaddingRight, int mapPaddingBottom)
        {
